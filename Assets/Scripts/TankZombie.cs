...
public class TankZombie : MonoBehaviour, IDamagable
{
    #region Attributes
    ...
    public static TankZombieSpawner[] tankZombieSpawners;
    ...
    void Awake()
    {
        ...
        tankZombieSpawners = FindObjectsByType<TankZombieSpawner>(FindObjectsSortMode.None);
    }
    ...
    void OnDisable()
    {
        foreach (TankZombieSpawner tankZombieSpawner in tankZombieSpawners)
        {
            if (tankZombieSpawner.zombieLists.Contains(this))
            {
                tankZombieSpawner.zombieLists.Remove(this);
                break;
            }
        }
    }
